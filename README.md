# Typescript $ Node.js Assignment(45Questions)
My First Assignment in Governor Sindh IT  Initiative for Artificial Intelligence, Web 3.0 & Metaverse.
...
1. Install Node js,TypeScript and VS Code.
